...
#GPU ansprechen falls möglich
print("CUDA ist {} ist verfuegbar.".format(torch.cuda.is_available()))
...
def quantization(title='optimize',
  ...
  if deploy and (batch_size != 1):
    ...
    # Model mit mehreren GPU verarbeiten
