...
class BankNodes(py_nndct.nn.NndctQuantModel):
    def __init__(self):
        ...
        self.module_1 = py_nndct.nn.Linear(in_features=4, out_features=32, bias=True) #BankNodes::BankNodes/Sequential[network]/Linear[fc1]/input.1
        self.module_2 = py_nndct.nn.ReLU(inplace=False) #BankNodes::BankNodes/Sequential[network]/ReLU[relu1]/48
        self.module_3 = py_nndct.nn.Linear(in_features=32, out_features=32, bias=True) #BankNodes::BankNodes/Sequential[network]/Linear[fc2]/input
        self.module_4 = py_nndct.nn.ReLU(inplace=False) #BankNodes::BankNodes/Sequential[network]/ReLU[relu2]/50
        self.module_5 = py_nndct.nn.Linear(in_features=32, out_features=1, bias=True) #BankNodes::BankNodes/Sequential[network]/Linear[fc3]/51
